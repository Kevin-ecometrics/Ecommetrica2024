const teamMembers = [
  ...
  },
  {
    ...
    description: "Juan Carlos Guerrero is a tenacious sales strategist with a vision focused on growth and innovation. His focus on analytics, negotiation, and customer relationships drives the success of every project.",
    ...
    detailedSkills: `<strong>Sales and Technology:</strong> 18 years of experience in companies in the US and Mexico, from part-time salesperson to sales director.<br><strong>Politics:</strong> Over 20 years in Mexico as a political operator and delegate, as well as having been a candidate and coordinator of multiple campaigns.<br><strong>Agriculture:</strong> Over 20 years in commercial, semi-industrial, and ornamental farming in Mexico and the US, combining production with his passion for the countryside.`,
