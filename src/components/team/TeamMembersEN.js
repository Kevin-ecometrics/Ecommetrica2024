const teamMembers = [
  {
    ...
    description: "Kevin is versatile in facilitating and streamlining programming processes to make your website functional and attractive.",
    ...
    extendedDescription2: "Kevin is a Full-Stack Developer specializing in web and mobile app development, with over 4 years of experience in technology and digital development.",
  ...
  },
  {
    ...
    description: "Karen is a creative professional who amplifies your project’s voice to attract clients and maximize growth.",
    ...
    extendedDescription2: "She holds a degree in Communication and Advertising, with 5 years of experience in creative writing, advertising design, eCommerce, and multimedia editing.",   
  ...
  },
  {
    ...
    description: "Yaz is a user experience expert with creative designs that attract and help achieve your business goals.",
   ...
   extendedDescription2: "Yaz is a UX/UI graphic designer with over 14 years of experience, standing out for her broad vision in marketing and software design.",
  ...
  },
  {
    ...
    image: "/team4.webp",
    image2: "/team4-2.webp",
    "name": "Juan-Manuel-González-Castillo",
    fullName: "Juan M. González",
    role: "CEO & Consultant",
    skills: "E-commerce, Data Analysis, Programming, SEO, Growth Hacking",
    transition: "imagen4",
    experience: "Over 10 years of experience in digital business consulting and e-commerce, with a focus on digital marketing, agriculture, automation, and logistics.",
    education: "Master's in Applied Economics",
    contact: "664 642 9633",
    proyecto: "E-commetrica, Founder and Consultant specialized in e-commerce.",
    proyecto2: "Development of Shopify stores with Liquid, advanced automation solutions, and growth hacking strategies.",
    proyecto3: "Developer of analytical dashboards in R and programming in React.",
    ...
    testimonio: "Juan Manuel is a strategic consultant with a deep understanding of digital platforms and e-commerce.",
    ...
    description: "Juan Manuel is an expert in optimizing positioning, the digital ecosystem, and strategic planning to help your business grow.",
    ...
    extendedDescription2: "Juan Manuel is an e-commerce expert with an innovative approach and a technical mastery that enables him to develop advanced solutions for digital commerce.",
    ...
    workEthic: `Working with Manuel González means partnering with a creative who is always rethinking and reformulating ideas to generate innovation and a unique digital footprint. His passion for technology and digital commerce drives him to develop strategic solutions, always three steps ahead of the competition.`,
    additionalDetails: {
      funFacts: [
        "A lover of travel.",
        "An avid reader.",
  ...
  },
  {
    ...
    proyecto2: "Border Grower, E-commerce Director and Programmer in R and Liquid.",
    ...
    description: "Juan Carlos is a tenacious sales strategist with a vision focused on growth and innovation. His approach to analytics, negotiation, and client relationships drives the success of each project.",
 ...
 //   extendedDescription2: "Juan Carlos is a tenacious sales strategist with a vision focused on growth and innovation. His approach to analytics, negotiation, and client relationships drives the success of each project",
  ...
  }, 
  {
    ...
    image: "/team6.webp",
    image2: "/team6-2.webp",
    name: "Jesus-Emmanuel-Castillo-Martínez",
    ...
    description: "Jesús is passionate about creating intuitive and efficient digital experiences, combining design and development to optimize usability and performance.",
    ...
    extendedDescription2: "Jesús is a Jr Programmer at E-commetrica with experience in web and software development.",
  ...
  },
  {
    ...
    description: "Maria José, with her fresh and original approach, provides new perspectives to clients, elevating each production with quality and style.",
    ...
    extendedDescription2: "Maria José is an editor with an artistic and creative approach who has worked on various design and marketing projects.",
