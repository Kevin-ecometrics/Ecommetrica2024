...
export const ui = {
  ...
  "contact.description": "Llena la forma para ponernos en contacto o llamar de: 9:00 a.m. a 6:00 p.m de Lunes a Viernes. para comenzar a darle vida a tus proyectos.",
  ...
  "service.description": "Además de nuestro servicio de consultoría, nos apasiona crear estrategias y tecnología para diferentes negocios con un equipo multidisciplinario en marketing digital y producción.",
  ...
  "packages.inicial.service1desc": "Desarrollo de una landing page en React o Astro según necesidad",
  "packages.inicial.service2": "SEO Inicial",
  "packages.inicial.service2desc": "Optimización básica en motores de búsqueda para mejorar visibilidad",
  "packages.inicial.service3": "Configuración de Redes Sociales",
  "packages.inicial.service3desc": "Creación y optimización de perfiles en redes sociales principales",
  "packages.inicial.service4": "Google Analytics & Facebook Pixel",
  "packages.inicial.service4desc": "Configuración de herramientas de seguimiento para análisis de tráfico",
  ...
  "packages.pro.service1desc": "Configuración y personalización de tienda en Shopify con diseño profesional",
  "packages.pro.service2": "SEO Avanzado",
  "packages.pro.service2desc": "Optimización técnica y estrategia de contenido para posicionamiento orgánico",
  "packages.pro.service3": "Google Tag Manager & GA4",
  "packages.pro.service3desc": "Implementación avanzada de Google Analytics 4 y Tag Manager",
  "packages.pro.service4": "Diseño de Posts & Reels",
  "packages.pro.service4desc": "Creación de contenido visual optimizado para redes sociales",
  ...
  "packages.empresa.service1desc": "Creación de un sitio web en React o Astro con diseño a medida",
  "packages.empresa.service2": "Estrategia en Redes Sociales",
  "packages.empresa.service2desc": "Gestión de contenido con planificación mensual y analítica avanzada",
  "packages.empresa.service3": "Publicidad Digital",
  "packages.empresa.service3desc": "Campañas en Google Ads, Facebook Ads e Instagram con segmentación avanzada",
  "packages.empresa.service4": "Branding & Diseño Gráfico",
  "packages.empresa.service4desc": "Diseño de identidad visual en Figma, Photoshop e Illustrator",
  ...
  "packages.personalizado.service2desc": "Flujos automatizados con IA y remarketing avanzado en múltiples plataformas",
  ...
  "packages.personalizado.service4desc": "Estrategias omnicanal para posicionamiento premium en el mercado",
  ...
  "skills.description1": "With over 10 years of experience in eCommerce, we have accompanied brands and companies throughout their digital transformation, creating visually sophisticated, technologically innovative, and multifunctional websites and web applications.",
  "skills.description2": "You will walk in your own digital ecosystem, placing your business alongside the Visas and Mastercards of your Customers and Consumers.",
  ...
  "packages.inicial.service1desc": "Development of a landing page in React or Astro as needed",
  "packages.inicial.service2": "Initial SEO",
  "packages.inicial.service2desc": "Basic search engine optimization to improve visibility",
  "packages.inicial.service3": "Social Media Setup",
  "packages.inicial.service3desc": "Creation and optimization of profiles on major social networks",
  "packages.inicial.service4": "Google Analytics & Facebook Pixel",
  "packages.inicial.service4desc": "Configuration of tracking tools for traffic analysis",
  ...
  "packages.pro.service1desc": "Shopify store setup and customization with professional design",
  "packages.pro.service2": "Advanced SEO",
  "packages.pro.service2desc": "Technical optimization and content strategy for organic positioning",
  "packages.pro.service3": "Google Tag Manager & GA4",
  "packages.pro.service3desc": "Advanced implementation of Google Analytics 4 and Tag Manager",
  "packages.pro.service4": "Post & Reel Design",
  "packages.pro.service4desc": "Creation of optimized visual content for social media",
  ...
  "packages.empresa.service1desc": "Creation of a website in React or Astro with custom design",
  "packages.empresa.service2": "Social Media Strategy",
  "packages.empresa.service2desc": "Content management with monthly planning and advanced analytics",
  "packages.empresa.service3": "Digital Advertising",
  "packages.empresa.service3desc": "Campaigns on Google Ads, Facebook Ads, and Instagram with advanced targeting",
  "packages.empresa.service4": "Branding & Graphic Design",
  "packages.empresa.service4desc": "Visual identity design in Figma, Photoshop, and Illustrator",
  ...
  "packages.personalizado.service1desc": "Personalized advice for digital expansion and growth",
  "packages.personalizado.service2": "Marketing Automation",
  "packages.personalizado.service2desc": "Automated workflows with AI and advanced remarketing on multiple platforms",
  "packages.personalizado.service3": "Audiovisual Production",
  "packages.personalizado.service3desc": "Professional video recording and editing for advertising campaigns",
  "packages.personalizado.service4": "Rebranding & Brand Positioning",
  "packages.personalizado.service4desc": "Omnichannel strategies for premium market positioning",
