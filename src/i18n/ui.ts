    ...
    "services": [
      {
        ...
        description: "Diseñamos y ejecutamos todos los procesos clave de preproducción, producción y post producción para trasformar la visión de nuestros clientes en realidad, adaptándonos al formato que se requiera.",
      },
      {
        id: 1,
        name: "Identidad de marca",
        description: "Mas allá de un logo unificamos nombre, colores y estrategia de marketing para lograr una coherencia visual poderosa que tenga presencia para los consumidores.",
      },
      {
        id: 2,
        name: "Escritura creativa",
        description: "Le damos alma y personalidad a tu marca o negocio mientras jugamos con la imaginación y creatividad para crear narrativas e historias que conecten con la gente.",
      },
      {
        id: 3,
        name: "Posicionamiento Web",
        description: "Impulsamos tu negocio en motores de búsqueda. Diseñamos estrategias integrales que maximizan la retención de leads y la conversión. Creamos ecosistemas digitales conectando tu página web con redes sociales, producimos y distribuimos contenido de alto valor, y ejecutamos campañas de email marketing altamente efectivas.",
      },
      {
        id: 4,
        name: "Programación y webApps",
        description: "Desarrollamos páginas y tiendas en línea impactantes y adaptables que crecen contigo. Hechas a tu gusto, necesidad y flujo que requieras. Así mismo cada cliente obtiene una aplicación web personalizada que simplifica la gestión de su negocio, en la que podrá acceder a toda su información, calendarios de citas, reseñas, envíos de correos masivos y mucho más en un clic.",
      },
      {
        id: 5,
        name: "Diseño web",
        description: "Nos enfocamos en Brindar una experiencia de usuario UX y diseño interfaz que se diferencie del resto, con un alto rendimiento y funcionalidad superior para que tus potenciales clientes o pacientes disfruten una experiencia cómoda y única.",
      },
      {
        id: 6,
        name: "E-commerce",
        description: "Nos especializamos en B2C, B2B, te guiamos paso a paso para diseñar un plan estratégico que impulse tu crecimiento, te guiamos a comprender a fondo el mercado y a definir con claridad tus productos y servicios. Fusionamos nuestra tecnología para seleccionar la plataforma más apropiada que te brinde autonomía, apertura a nivel regional e internacional y automatice tus procesos para maximizar eficiencia y resultados.",
      },
      {
        id: 7,
        name: "Planeación estratégica",
        description: "Nos enfocamos en el crecimiento de tu negocio, te ayudamos a identificar oportunidades de mejora y a implementar estrategias que te permitan alcanzar tus objetivos.",
      },
    ],
      ...
      "services": [
        {
          ...
          description: "We design and execute all key processes of pre-production, production, and post-production to transform our clients' vision into reality, adapting to the required format.",
        },
        {
          id: 1,
          name: "Brand Identity",
          description: "Beyond a logo, we unify name, colors, and marketing strategy to achieve a powerful visual coherence that resonates with consumers.",
        },
        {
          id: 2,
          name: "Creative Writing",
          description: "We give soul and personality to your brand or business while playing with imagination and creativity to create narratives and stories that connect with people.",
        },
        {
          id: 3,
          name: "Web Positioning",
          description: "We boost your business on search engines. We design comprehensive strategies that maximize lead retention and conversion. We create digital ecosystems by connecting your website with social media, produce and distribute high-value content, and execute highly effective email marketing campaigns.",
        },
        {
          id: 4,
          name: "Programming and Web Apps",
          description: "We develop impactful and adaptable online pages and stores that grow with you. Tailored to your taste, needs, and required workflow. Additionally, each client receives a customized web application that simplifies business management, allowing access to all their information, appointment calendars, reviews, mass emailing, and much more with just one click.",
        },
        {
          id: 5,
          name: "Web Design",
          description: "We focus on providing a user experience (UX) and interface design that stands out from the rest, with high performance and superior functionality so your potential clients or patients enjoy a comfortable and unique experience.",
        },
        {
          id: 6,
          name: "E-commerce",
          description: "We specialize in B2C and B2B, guiding you step by step to design a strategic plan that drives your growth. We help you thoroughly understand the market and clearly define your products and services. We combine our technology to select the most appropriate platform that gives you autonomy, regional and international reach, and automates your processes to maximize efficiency and results.",
        },
        {
          id: 7,
          name: "Strategic Planning",
          description: "We focus on the growth of your business, helping you identify improvement opportunities and implement strategies that allow you to achieve your goals.",
        },
      ],
      "service.readyTitle": "Ready to bring your projects to life",
      "service.ourServices": "Our Services",
